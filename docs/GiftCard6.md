...
**initialValue** | **string** | Initial value of the Gift Card. | [default to undefined]
**balance** | **string** | Current balance of the Gift Card. | [optional] [readonly] [default to undefined]
**sourceInfo** | [**GiftCardSourceInfo2**](GiftCardSourceInfo2.md) |  | [default to undefined]
...
```typescript
import { GiftCard6 } from 'rise-typescript-sdk';

const instance: GiftCard6 = {
    id,
    code,
    initialValue,
    balance,
