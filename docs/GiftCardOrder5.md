...
------------ | ------------- | ------------- | -------------
**id** | **string** | Order ID. | [readonly] [default to undefined]
**revision** | **string** | Revision number, which increments by 1 each time the Order is updated. To prevent conflicting changes, the current revision must be passed when updating the Order.  Ignored when creating a Order. | [readonly] [default to undefined]
...
```typescript
import { GiftCardOrder5 } from 'rise-typescript-sdk';

const instance: GiftCardOrder5 = {
    id,
    revision,
    createdDate,
    updatedDate,
