...
**name** | **string** | The name of the recipient. | [default to undefined]
**email** | **string** | The email of the recipient. | [default to undefined]
**giftCardId** | **string** | The ID of the gift card that was sent to the recipient. | [default to undefined]
**giftingDetails** | [**GiftingDetails1**](GiftingDetails1.md) |  | [optional] [default to undefined]

## Example

```typescript
import { Recipient4 } from 'rise-typescript-sdk';

const instance: Recipient4 = {
    id,
    revision,
    createdDate,
    updatedDate,
