...
**scheduleDate** | **string** | Activation schedule date | [optional] [default to undefined]

## Example

```typescript
import { ScheduleActivationRequested } from 'rise-typescript-sdk';

const instance: ScheduleActivationRequested = {
    id,
    externalEntityId,
    payload,
    automation,
