...
**cursors** | **object** | Cursors to navigate through the result pages using &#x60;next&#x60; and &#x60;prev&#x60;. Returned if cursor paging is used. | [optional] [default to undefined]

## Example

```typescript
import { PagingMetadataV2 } from 'rise-typescript-sdk';

const instance: PagingMetadataV2 = {
    count,
    offset,
    total,
    tooManyToCount,
