...
**sourceOrderId** | **string** | Order ID in Source. | [optional] [default to undefined]

## Example

```typescript
import { OrderSourceInfoSourceInfo } from 'rise-typescript-sdk';

const instance: OrderSourceInfoSourceInfo = {
    sourceChannelId,
    sourceTenantId,
    sourceOrderId,
};
