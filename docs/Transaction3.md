...
**giftCardId** | **string** | Unique ID of the gift card associated with this transaction. | [default to undefined]
**amount** | **string** | Transaction amount. | [default to undefined]
...
```typescript
import { Transaction3 } from 'rise-typescript-sdk';

const instance: Transaction3 = {
    id,
    createdDate,
    type,
    giftCardId,
