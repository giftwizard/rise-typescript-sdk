...
**sourceInfo** | **object** | Information about the source of the gift card. | [optional] [default to undefined]
...
**lastTransactionId** | **string** | ID of the last transaction that modified the gift card balance. | [optional] [readonly] [default to undefined]
...
**transactionDetails** | **object** | Transaction details related to the gift card. | [optional] [readonly] [default to undefined]

## Example

```typescript
import { GiftCard } from 'rise-typescript-sdk';

const instance: GiftCard = {
    id,
    code,
    initialValue,
    balance,
