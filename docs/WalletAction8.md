...
------------ | ------------- | ------------- | -------------
**id** | **string** | WalletAction ID. | [readonly] [default to undefined]
**revision** | **string** | Represents the current state of an item. Each time the item is modified, its &#x60;revision&#x60; changes. For an update operation to succeed, you MUST pass the latest revision. | [readonly] [default to undefined]
...
**storeCreditContext** | [**StoreCreditContext1**](StoreCreditContext1.md) |  | [optional] [default to undefined]
...
```typescript
import { WalletAction8 } from 'rise-typescript-sdk';

const instance: WalletAction8 = {
    id,
    revision,
    createdDate,
    updatedDate,
