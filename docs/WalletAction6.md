...
**amount** | **string** | The amount to be added to the Wallet. | [default to undefined]
...
**storeCreditContext** | [**StoreCreditContext1**](StoreCreditContext1.md) |  | [default to undefined]
**externalEvent** | [**ExternalEvent2**](ExternalEvent2.md) |  | [optional] [default to undefined]
**walletId** | **string** | ID of the wallet to which the WalletAction belongs. | [default to undefined]
...
```typescript
import { WalletAction6 } from 'rise-typescript-sdk';

const instance: WalletAction6 = {
    id,
    revision,
    createdDate,
    updatedDate,
