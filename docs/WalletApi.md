...
# **countWallets**
> CountWalletsResponse countWallets(walletWalletServiceV1RiseWalletsCountPostCountWalletsRequestBody)
...
> GetCustomerReferenceResponse getCustomerReference()
...
# **getOrCreateWallet**
> GetOrCreateWalletResponse getOrCreateWallet(walletWalletServiceV1RiseWalletsIssuePostGetOrCreateWalletRequestBody)
...
# **queryWallets**
> QueryWalletsResponse1 queryWallets(walletActionWalletActionServiceV1RiseWalletActionsQueryPostQueryWalletActionsRequestBody)
