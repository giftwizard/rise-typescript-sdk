...
export const ActionInitiator1TypeEnum = {
    Order1valueApPdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"APP\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueUseRdescriptionMaturityGAexposurePublic: '{\"order\":2,\"value\":\"USER\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
 ...
 * 
 */
export interface AddCustomerReferenceResponse {
    /**
     * Customer reference
     */
    'customerReference'?: object;
 ...
 * 
 */
export type AggregationResults1 = DateHistogramResults1 | GroupByValueResults1 | NestedResults1 | RangeResults1 | ScalarResult1 | ValueResults1;
...
export const AggregationType = {
    ...
    Order5valueNesteDdescriptionFlattenedListOfAggregationsWhereEachAggregationIsNestedWithinPreviousOneMaturityGAexposurePublic: '{\"order\":5,\"value\":\"NESTED\",\"description\":\"Flattened list of aggregations, where each aggregation is nested within previous one.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
...
export const BlockType = {
    Order0valueUnknowNdescriptionMaturityGAexposurePublic: '{\"order\":0,\"value\":\"UNKNOWN\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order1valueORdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"OR\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueAnDdescriptionMaturityGAexposurePublic: '{\"order\":2,\"value\":\"AND\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
 ...
 */
export interface BulkOptions1 {
    'bulkOptions'?: BulkOptions1;
}
/**
 * Detailed information about a Gift Card or Gift Card transaction issued from a bulk.
 */
export interface BulkOptions2 {
    'bulkOptions'?: BulkOptions2;
}
/**
 * 
 */
 ...
 */
export interface CampaignOptions1 {
    'campaignOptions'?: CampaignOptions1;
}
/**
 * Bulk Options (deprecated) (**Deprecated**: Use `bulk_options` instead.)
 */
export interface CampaignOptions2 {
    'campaignOptions'?: CampaignOptions2;
}
/**
 * 
 */
...
export const CancellationReason = {
    Order1valueEventCancelleDdescriptionIndicatesThatTheActivationWasCancelledDirectlyMaturityGAexposurePublic: '{\"order\":1,\"value\":\"EVENT_CANCELLED\",\"description\":\"Indicates that the activation was cancelled directly.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueAutomationDeactivateDdescriptionIndicatesThatTheActivationWasCancelledBecauseTheAutomationWasDeactivatedMaturityGAexposurePublic: '{\"order\":2,\"value\":\"AUTOMATION_DEACTIVATED\",\"description\":\"Indicates that the activation was cancelled because the automation was deactivated.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order3valueAutomationDeleteDdescriptionIndicatesThatTheActivationWasCancelledBecauseTheAutomationWasDeletedMaturityGAexposurePublic: '{\"order\":3,\"value\":\"AUTOMATION_DELETED\",\"description\":\"Indicates that the activation was cancelled because the automation was deleted.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order4valueCancelledByRefreshPayloaDdescriptionIndicatesThatTheActivationWasCancelledAfterTheAutomationScheduleTimeWasReachedMaturityGAexposurePublic: '{\"order\":4,\"value\":\"CANCELLED_BY_REFRESH_PAYLOAD\",\"description\":\"Indicates that the activation was cancelled after the automation schedule time was reached.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order5valueCancelledByGdprRequesTdescriptionIndicatesThatTheActivationWasCancelledDueToAUoUGdprRightToBeForgottenRequestMaturityGAexposurePublic: '{\"order\":5,\"value\":\"CANCELLED_BY_GDPR_REQUEST\",\"description\":\"Indicates that the activation was cancelled due to a UoU GDPR \\\"Right to be Forgotten\\\" request.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
 ...
 * 
 */
export interface CountWalletsRequest {
    /**
 ...
 * 
 */
export interface CountWalletsResponse1 {
    /**
     * Number of wallets matching the filter.
     */
    'count'?: number;
 ...
 * 
 */
export interface CreateGiftCardResponse1 {
    'giftCard'?: GiftCard1;
}
/**
 * 
 */
export interface CreateMigrationGiftCardRequest {
    /**
 ...
 * 
 */
export interface CreateMigrationGiftCardResponse {
    /**
 ...
 * 
 */
export interface CreateMigrationRecipientRequest {
    /**
 ...
 * 
 */
export interface CreateMigrationRecipientResponse {
    /**
 ...
 * 
 */
export interface CreateMigrationTransactionRequest {
    /**
 ...
 * 
 */
export interface CreateMigrationTransactionResponse {
    /**
 ...
 * 
 */
export interface CreateMigrationWalletActionResponse {
    /**
 ...
 * 
 */
export interface CreateOrderResponse1 {
 ...
 * 
 */
export interface CreateWalletActionRequest {
    /**
     * WalletAction to be created.
     */
    'walletAction'?: object;
 ...
 * 
 */
export interface CreateWalletActionResponse1 {
    'walletAction'?: WalletAction1;
}
/**
 * 
 ...
 */
export interface CursorPaging1 {
    /**
     * Number of items to load.
     */
    'limit'?: number;
 ...
 * Cursor token pointing to a page of results. Not used in the first request. Following requests use the cursor token and not `filter` or `sort`.
 */
export interface CursorPaging2 {
    'cursorPaging'?: CursorPaging2;
}
/**
 * Cursor token pointing to a page of results. Not used in the first request. Following requests use the cursor token and not `filter` or `sort`.
 */
export interface CursorPaging3 {
    'cursorPaging'?: CursorPaging3;
}
/**
 ...
 */
export interface CursorPaging4 {
    /**
     * Maximum number of items to return in the results.
     */
    'limit'?: number;
    /**
     * Pointer to the next or previous page in the list of results.  Pass the relevant cursor token from the `pagingMetadata` object in the previous call\'s response. Not relevant for the first request.
     */
    'cursor'?: string;
}
/**
 ...
 * 
 */
export interface DateHistogramResult1 {
    /**
     * Date in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
     */
    'value'?: string;
 ...
 */
export interface DateHistogramResults1 {
    'dateHistogram'?: DateHistogramResults1;
}
/**
 ...
 * 
 */
export interface DecreaseBalanceResponse1 {
 ...
 * 
 */
export interface DeleteCustomerReferenceRequest {
    /**
     * Query by customer reference source (i.e. source channel, tenant, and customer IDs)
     */
    'query'?: object;
}
/**
 ...
 * 
 */
export interface DeleteWalletActionRequest {
    /**
 ...
 * 
 */
export interface DisableGiftCardRequest {
    /**
     * The ID of the GiftCard to disable.
     */
    'giftCardId'?: string;
}
/**
 ...
 * 
 */
export interface DisableGiftCardResponse1 {
    'giftCard'?: GiftCard4;
}
/**
 ...
 * 
 */
export interface DisableWalletActionResponse1 {
...
export const Domain = {
    Order0valueUseRdescriptionUserDomainDefaultMaturityGAexposurePublic: '{\"order\":0,\"value\":\"USER\",\"description\":\"User domain (default).\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order1valueWiXdescriptionWixDomainMaturityGAexposurePublic: '{\"order\":1,\"value\":\"WIX\",\"description\":\"Wix domain.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueWixAccounTdescriptionWixAccountLevelDomainMaturityGAexposurePublic: '{\"order\":2,\"value\":\"WIX_ACCOUNT\",\"description\":\"Wix Account level domain.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
 ...
 * 
 */
export interface EndMigrationWalletActionResponse {
    /**
...
export const ErrorReason = {
    Order0valueUnexpectedErrorReasoNdescriptionUnexpectedErrorReasonmaturityGAexposurePublic: '{\"order\":0,\"value\":\"UNEXPECTED_ERROR_REASON\",\"description\":\"Unexpected error reason\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order1valueScheduleDateEvaluationFaileDdescriptionFailedToEvaluateTheScheduleDateExpressionmaturityGAexposurePublic: '{\"order\":1,\"value\":\"SCHEDULE_DATE_EVALUATION_FAILED\",\"description\":\"Failed to evaluate the schedule date expression\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
 ...
 */
export type Expiration1 = FixedDate | RelativeExpiresAt1;
...
export const ExternalEvent1NameEnum = {
    Order1valueOrdeRdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"ORDER\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueRefunDdescriptionMaturityGAexposurePublic: '{\"order\":2,\"value\":\"REFUND\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order3valueReferraLdescriptionMaturityGAexposurePublic: '{\"order\":3,\"value\":\"REFERRAL\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order4valueSignUPdescriptionMaturityGAexposurePublic: '{\"order\":4,\"value\":\"SIGN_UP\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order5valueMembershiPdescriptionMaturityGAexposurePublic: '{\"order\":5,\"value\":\"MEMBERSHIP\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order6valueCompensatioNdescriptionMaturityGAexposurePublic: '{\"order\":6,\"value\":\"COMPENSATION\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order7valueOtheRdescriptionMaturityGAexposurePublic: '{\"order\":7,\"value\":\"OTHER\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
...
export const FraudType = {
    Order0valueUnknownFraudTypEdescriptionMaturityGAexposurePublic: '{\"order\":0,\"value\":\"UNKNOWN_FRAUD_TYPE\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order1valueNonEdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"NONE\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueShopifyIndicatioNdescriptionMaturityGAexposurePublic: '{\"order\":2,\"value\":\"SHOPIFY_INDICATION\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order3valueRiseBoughtWithGiftCarDdescriptionMaturityGAexposurePublic: '{\"order\":3,\"value\":\"RISE_BOUGHT_WITH_GIFT_CARD\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order4valueRiseBoughtWithDiscounTdescriptionMaturityGAexposurePublic: '{\"order\":4,\"value\":\"RISE_BOUGHT_WITH_DISCOUNT\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
...
export const FulfillmentStatus = {
    Order0valueUnknownFulfillmentStatuSdescriptionMaturityGAexposurePublic: '{\"order\":0,\"value\":\"UNKNOWN_FULFILLMENT_STATUS\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order1valuePendinGdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"PENDING\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueFulfilleDdescriptionMaturityGAexposurePublic: '{\"order\":2,\"value\":\"FULFILLED\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order3valueInProgresSdescriptionMaturityGAexposurePublic: '{\"order\":3,\"value\":\"IN_PROGRESS\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order4valueNotFulfilleDdescriptionMaturityGAexposurePublic: '{\"order\":4,\"value\":\"NOT_FULFILLED\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order5valueDelayeDdescriptionMaturityGAexposurePublic: '{\"order\":5,\"value\":\"DELAYED\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
 ...
 * 
 */
export interface GetCustomerReferenceResponse1 {
 ...
 * 
 */
export interface GetGiftCardConsistentRequest {
    /**
 ...
 * 
 */
export interface GetGiftCardConsistentResponse {
    /**
 ...
 * 
 */
export interface GetGiftCardResponse1 {
    'giftCard'?: GiftCard2;
}
/**
 * 
 ...
 * 
 */
export interface GetOrCreateWalletResponse1 {
    'wallet'?: Wallet4;
}
/**
 * 
 ...
 * 
 */
export interface GetOrCreateWalletV2Response {
    /**
     * The retrieved or created wallet.
     */
    'wallet'?: object;
 ...
 * 
 */
export interface GetRecipientResponse1 {
    'recipient'?: Recipient2;
}
/**
 * 
 */
export interface GetRefundableAmountsRequest {
    /**
 ...
 * 
 */
export interface GetWalletActionRequest {
    /**
 ...
 * 
 */
export interface GetWalletActionResponse {
    /**
 ...
 * 
 */
export interface GetWalletGiftCardRequest {
    /**
     * Wallet ID, email, or customer reference source by which to retrieve the gift card.
     */
    'query'?: object;
}
/**
 * 
 */
export interface GetWalletGiftCardResponse {
    /**
 ...
 * 
 */
export interface GetWalletResponse1 {
    'wallet'?: Wallet2;
}
/**
 * 
 ...
 * 
 */
export interface GetWalletV2Response {
    /**
     * The retrieved Wallet.
     */
    'wallet'?: object;
...
export interface GiftCardGiftCardServiceV1RiseGiftCardsSearchPostSearchGiftCardsRequestBody {
    'search'?: PagingMethod2;
}
/**
 * 
 */
export interface GiftCardGiftCardServiceV1RiseGiftCardsTransactionGiftCardIdDecreasePostDecreaseBalanceRequestBody {
 ...
 * 
 */
export interface GiftCardInitialized {
    /**
     * 
     */
    'giftCard'?: object;
...
export const GiftCardOrder1PaymentStatusEnum = {
    Order0valueUnknownPaymentStatuSdescriptionMaturityGAexposurePublic: '{\"order\":0,\"value\":\"UNKNOWN_PAYMENT_STATUS\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order1valueNotPaiDdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"NOT_PAID\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valuePartiallyPaiDdescriptionMaturityGAexposurePublic: '{\"order\":2,\"value\":\"PARTIALLY_PAID\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order3valuePaiDdescriptionMaturityGAexposurePublic: '{\"order\":3,\"value\":\"PAID\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order4valueRefundeDdescriptionMaturityGAexposurePublic: '{\"order\":4,\"value\":\"REFUNDED\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order5valuePartiallyRefundeDdescriptionMaturityGAexposurePublic: '{\"order\":5,\"value\":\"PARTIALLY_REFUNDED\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order6valueCanceleDdescriptionMaturityGAexposurePublic: '{\"order\":6,\"value\":\"CANCELED\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
...
export const GiftCardOrder1StatusEnum = {
    Order0valueUnknownOrderStatuSdescriptionMaturityGAexposurePublic: '{\"order\":0,\"value\":\"UNKNOWN_ORDER_STATUS\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order1valueValiDdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"VALID\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueRejecteDdescriptionMaturityGAexposurePublic: '{\"order\":2,\"value\":\"REJECTED\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order3valueSuspiciouSdescriptionMaturityGAexposurePublic: '{\"order\":3,\"value\":\"SUSPICIOUS\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
 ...
 * Information about the source of the gift card.
 */
export type GiftCardSourceInfo1 = BulkOptions2 | CampaignOptions2 | ManualOptions2 | MigrationOptions2 | OrderOptions1 | StoreCreditOptions1 | WorkflowOptions1;

/**
 * @type GiftCardSourceInfo2
 * Information about the source of the gift card.
 */
export type GiftCardSourceInfo2 = BulkOptions2 | CampaignOptions2 | ManualOptions2 | MigrationOptions2 | OrderOptions1 | StoreCreditOptions1 | WorkflowOptions1;
...
export const GiftCardType = {
    Order1valueOrdeRdescriptionIssuedFromAnOrderMaturityGAexposurePublic: '{\"order\":1,\"value\":\"ORDER\",\"description\":\"Issued from an order.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueCampaigNdescriptionMaturityGAexposurePublic: '{\"order\":2,\"value\":\"CAMPAIGN\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order3valueMigratioNdescriptionMigratedFromRiseV1OrAnotherPlatformMaturityGAexposurePublic: '{\"order\":3,\"value\":\"MIGRATION\",\"description\":\"Migrated from Rise V1 or another platform.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order4valueStoreCrediTdescriptionBelongsToAStoreCreditWalletMaturityGAexposurePublic: '{\"order\":4,\"value\":\"STORE_CREDIT\",\"description\":\"Belongs to a Store Credit Wallet.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order5valueManuaLdescriptionIssuedFromTheDashboardMaturityGAexposurePublic: '{\"order\":5,\"value\":\"MANUAL\",\"description\":\"Issued from the dashboard.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order6valueWorkfloWdescriptionIssuedFromAWorkflowMaturityGAexposurePublic: '{\"order\":6,\"value\":\"WORKFLOW\",\"description\":\"Issued from a workflow.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order7valueBulKdescriptionIssuedFromABulkOperationMaturityGAexposurePublic: '{\"order\":7,\"value\":\"BULK\",\"description\":\"Issued from a bulk operation.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
...
export const IdentifierType = {
    Order1valuePreinstalleDdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"PREINSTALLED\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
 ...
 */
export interface IncludeMissingValuesOptions1 {
    /**
     * Specify a custom name for the bucket containing the missing values. Defaults are `\"N/A\"` for strings, `0` for integers, and `false` for booleans.
     */
    'addToBucket'?: string;
 ...
 */
export interface InitialOptions1 {
    'initialOptions'?: InitialOptions1;
}
/**
 * 
 */
...
export const Interval = {
    Order1valueYeaRdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"YEAR\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueMontHdescriptionMaturityGAexposurePublic: '{\"order\":2,\"value\":\"MONTH\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order3valueWeeKdescriptionMaturityGAexposurePublic: '{\"order\":3,\"value\":\"WEEK\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order4valueDaYdescriptionMaturityGAexposurePublic: '{\"order\":4,\"value\":\"DAY\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order5valueHouRdescriptionMaturityGAexposurePublic: '{\"order\":5,\"value\":\"HOUR\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order6valueMinutEdescriptionMaturityGAexposurePublic: '{\"order\":6,\"value\":\"MINUTE\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order7valueSeconDdescriptionMaturityGAexposurePublic: '{\"order\":7,\"value\":\"SECOND\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
 ...
 * 
 */
export interface InvalidWalletActionDetails {
    /**
     * WalletAction ID.
     */
    'walletActionId'?: string;
 ...
 */
export interface ManualOptions1 {
    'manualOptions'?: ManualOptions1;
}
/**
 * Detailed information about a Gift Card that was created manually.
 */
export interface ManualOptions2 {
    'manualOptions'?: ManualOptions2;
}
/**
 * 
 */
 ...
 */
export interface MigrationOptions1 {
    'migrationOptions'?: MigrationOptions1;
}
/**
 * Detailed information about a Gift Card or Gift Card Transaction whose source is a migration from Rise V1 or another platform.
 */
export interface MigrationOptions2 {
    'migrationOptions'?: MigrationOptions2;
}
/**
 * 
 */
...
export const MissingValues = {
    Order0valueExcludEdescriptionExcludeMissingValuesFromTheAggregationResultsMaturityGAexposurePublic: '{\"order\":0,\"value\":\"EXCLUDE\",\"description\":\"Exclude missing values from the aggregation results.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order1valueIncludEdescriptionIncludeMissingValuesInTheAggregationResultsMaturityGAexposurePublic: '{\"order\":1,\"value\":\"INCLUDE\",\"description\":\"Include missing values in the aggregation results.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
...
export const Mode = {
    Order0valueORdescriptionAtLeastOneOfTheSearchTermsMustBePresentMaturityGAexposurePublic: '{\"order\":0,\"value\":\"OR\",\"description\":\"At least one of the search terms must be present.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order1valueAnDdescriptionAllSearchTermsMustBePresentMaturityGAexposurePublic: '{\"order\":1,\"value\":\"AND\",\"description\":\"All search terms must be present.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
 ...
 * Nested aggregations.
 */
export type NestedAggregationResults1 = DateHistogramResults1 | GroupedByValue | NestedResults1 | RangeResults1 | ScalarResult1 | ValueResults1;
 ...
 * 
 */
export type NestedResultValue1 = DateHistogramResults1 | GroupedByValue | Nested | RangeResults1 | ScalarResult1 | ValueResults1;
 ...
 */
export interface NestedResults1 {
    'nested'?: NestedResults1;
}
/**
 * 
 */
...
export const NullValueNullValueEnum = {
    Order0valueNullValuEdescriptionMaturityGAexposurePublic: '{\"order\":0,\"value\":\"NULL_VALUE\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
...
export const OperationType = {
    Order0valueAdDdescriptionMaturityGAexposurePublic: '{\"order\":0,\"value\":\"ADD\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order1valueSubtracTdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"SUBTRACT\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
...
export interface Options1 {
    'includeOptions'?: IncludeMissingValuesOptions1;
}
/**
 * 
 */
 ...
 * Detailed information about a Gift Card issued from an order.
 */
export interface OrderOptions1 {
 ...
 * Order ID or Source Identifiers of the Order to fulfill.
 */
export type OrderQuery1 = Id1 | OrderSourceInfo1;

/**
 * @type OrderQuery2
 * Order ID or Source Identifiers of the Order whose status is to be updated.
 */
export type OrderQuery2 = Id1 | OrderSourceInfo1;
 ...
 * Source Identifiers.
 */
export interface OrderSourceInfo1 {
    'sourceInfo'?: OrderSourceInfo1;
}
/**
 * 
 */
...
export const Origin = {
    Order1valueUseRdescriptionUserCreatedAutomationMaturityGAexposurePublic: '{\"order\":1,\"value\":\"USER\",\"description\":\"User created automation.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order3valueApplicatioNdescriptionAutomationCreatedByApplicationSiteSpecificMaturityGAexposurePublic: '{\"order\":3,\"value\":\"APPLICATION\",\"description\":\"Automation created by application (site specific).\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order4valuePreinstalleDdescriptionPreinstalledApplicationAutomationMaturityGAexposurePublic: '{\"order\":4,\"value\":\"PREINSTALLED\",\"description\":\"Preinstalled application automation.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order6valueRecipEdescriptionAutomationCreatedFromARecipeMaturityGAexposurePublic: '{\"order\":6,\"value\":\"RECIPE\",\"description\":\"Automation created from a recipe.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
 ...
 * 
 */
export interface PagingMethod1 {
    'cursorPaging'?: CursorPaging1;
}
/**
 * 
 */
export interface PagingMethod2 {
    'cursorPaging'?: CursorPaging4;
}
/**
 * 
 */
export interface PagingMethod3 {
    'cursorPaging'?: CursorPaging3;
}
/**
 * Path definition
...
export interface PaymentMethodRefundOptions {
     ...
     */
    'activeFundingTransaction'?: object;
}
/**
 * Information about a transaction whose source is a refunding a payment method.
 */
export interface PaymentMethodRefundOptions1 {
    'paymentMethodRefundOptions'?: PaymentMethodRefundOptions1;
}
/**
 * 
 */
 ...
 * 
 */
export interface ProduceTransactionAddedEventRequest {
    /**
     * 
     */
    'transactionId'?: string;
 ...
 * 
 */
export interface QueryGiftCardsRequest {
    /**
 ...
 * 
 */
export interface QueryTransactionsInternalRequest {
    /**
     * WQL expression.
     */
    'query'?: object;
 ...
 * 
 */
export interface QueryTransactionsInternalResponse {
    /**
 ...
 * 
 */
export interface QueryUnredeemedWalletActionsRequest {
    /**
     * API Query Language expression.
     */
    'query'?: object;
 ...
 * 
 */
export interface QueryUnredeemedWalletActionsResponse1 {
    /**
     * The retrieved unredeemed WalletActions with their balances.
     */
 ...
 * WQL expression.
 */
export type QueryV21 = CursorPaging2 | Paging1;

/**
 * @type QueryV22
 * API Query Language expression.
 */
export type QueryV22 = CursorPaging3 | Paging2;

/**
 * 
 */
export interface QueryWalletActionBalancesRequest {
    /**
     * API Query Language expression.
     */
    'query'?: object;
 ...
 */
export interface RangeResults1 {
    'ranges'?: RangeResults1;
}
/**
 * 
 */
 ...
 */
export interface RedeemOptions1 {
    'redeemOptions'?: RedeemOptions1;
}
/**
 * 
 */
...
export interface RegenerateCodeRequest {
    /**
     * The ID of the GiftCard to regenerate code for.
     */
    'giftCardId'?: string;
}
/**
 ...
 * Relative Expiration period
 */
export interface RelativeExpiresAt1 {
    'relative'?: RelativeExpiresAt1;
}
/**
 * 
 */
...
export const RequestedFields = {
    Order1valueContactDetailSdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"CONTACT_DETAILS\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
 ...
 */
export interface RewardOptions1 {
    'rewardOptions'?: RewardOptions1;
}
/**
 * 
 */
 ...
 * Scalar aggregation results.
 */
export interface ScalarResult1 {
    'scalar'?: ScalarResult1;
}
/**
 * 
 */
...
export const ScalarType = {
    Order1valueCountDistincTdescriptionTotalNumberOfDistinctValuesMaturityGAexposurePublic: '{\"order\":1,\"value\":\"COUNT_DISTINCT\",\"description\":\"Total number of distinct values.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueMiNdescriptionMinimumValueMaturityGAexposurePublic: '{\"order\":2,\"value\":\"MIN\",\"description\":\"Minimum value.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order3valueMaXdescriptionMaximumValueMaturityGAexposurePublic: '{\"order\":3,\"value\":\"MAX\",\"description\":\"Maximum value.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
...
export const ScheduleStatus = {
    Order0valueUnknownScheduleStatuSdescriptionMaturityGAexposurePublic: '{\"order\":0,\"value\":\"UNKNOWN_SCHEDULE_STATUS\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order1valuePendinGdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"PENDING\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueCancelleDdescriptionMaturityGAexposurePublic: '{\"order\":2,\"value\":\"CANCELLED\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order3valueDonEdescriptionMaturityGAexposurePublic: '{\"order\":3,\"value\":\"DONE\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
...
export const SortDirection = {
    Order0valueDesCdescriptionDescendingOrderMaturityGAexposurePublic: '{\"order\":0,\"value\":\"DESC\",\"description\":\"Descending order.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order1valueAsCdescriptionAscendingOrderMaturityGAexposurePublic: '{\"order\":1,\"value\":\"ASC\",\"description\":\"Ascending order.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
...
export const SortOrder = {
    Order0valueAsCdescriptionMaturityGAexposurePublic: '{\"order\":0,\"value\":\"ASC\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order1valueDesCdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"DESC\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
...
export const SortType = {
    Order0valueCounTdescriptionNumberOfMatchesInTheResultsMaturityGAexposurePublic: '{\"order\":0,\"value\":\"COUNT\",\"description\":\"Number of matches in the results.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order1valueValuEdescriptionAlphabeticallyByTheFieldValueMaturityGAexposurePublic: '{\"order\":1,\"value\":\"VALUE\",\"description\":\"Alphabetically by the field value.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
...
export const Status = {
    Order2valueStarteDdescriptionIndicatesThatActionActivationHasStartedAndIsInProgressNRelevantToActionTypesAppDefinedDelayMaturityGAexposurePublic: '{\"order\":2,\"value\":\"STARTED\",\"description\":\"Indicates that action activation has started and is in progress.\\nRelevant to action types: APP_DEFINED, DELAY.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order7valueInvokedAsynCdescriptionIndicatesThatAsyncActionWasInvokedAndNowWaitingToBeCompletedmaturityGAexposurePublic: '{\"order\":7,\"value\":\"INVOKED_ASYNC\",\"description\":\"Indicates that async action was invoked and now waiting to be completed\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order3valueEndeDdescriptionIndicatesThatTheActionActivationWasCompletedWithoutErrorsNRelevantToActionTypesAppDefinedDelayConditionRateLimitMaturityGAexposurePublic: '{\"order\":3,\"value\":\"ENDED\",\"description\":\"Indicates that the action activation was completed without errors.\\nRelevant to action types: APP_DEFINED, DELAY, CONDITION, RATE_LIMIT.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order5valueSkippeDdescriptionIndicatesThatTheActionWasSkippedAndPostActionsWontStartNRelevantToActionTypesAppDefinedMaturityGAexposurePublic: '{\"order\":5,\"value\":\"SKIPPED\",\"description\":\"Indicates that the action was skipped and post actions won\'t start.\\nRelevant to action types: APP_DEFINED.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order6valueFaileDdescriptionIndicatesThatTheActionFailedNRelevantToActionTypesAppDefinedDelayRateLimitMaturityGAexposurePublic: '{\"order\":6,\"value\":\"FAILED\",\"description\":\"Indicates that the action failed.\\nRelevant to action types: APP_DEFINED, DELAY, RATE_LIMIT.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
...
export const StoreCreditContext1IssuerEnum = {
    Order1valueWorkfloWdescriptionIssuedFromAWorkflowmaturityGAexposurePublic: '{\"order\":1,\"value\":\"WORKFLOW\",\"description\":\"Issued from a workflow\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueBulKdescriptionIssuedFromABulkmaturityGAexposurePublic: '{\"order\":2,\"value\":\"BULK\",\"description\":\"Issued from a bulk\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order3valueManuaLdescriptionIssuedFromTheRiseDashboardmaturityGAexposurePublic: '{\"order\":3,\"value\":\"MANUAL\",\"description\":\"Issued from the Rise dashboard\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order4valueOtheRdescriptionIssuedFromAnotherSourcematurityGAexposurePublic: '{\"order\":4,\"value\":\"OTHER\",\"description\":\"Issued from another source\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order5valueRefunDdescriptionIssuedFromARefundmaturityGAexposurePublic: '{\"order\":5,\"value\":\"REFUND\",\"description\":\"Issued from a refund\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order6valueReferralReferredCustomeRdescriptionIssuedFromAReferralAReferredCustomerCreatedAWalletFromTheReferralLinkmaturityGAexposurePublic: '{\"order\":6,\"value\":\"REFERRAL_REFERRED_CUSTOMER\",\"description\":\"Issued from a referral - a referred customer created a wallet from the referral link\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order7valueReferralReferreRdescriptionIssuedFromAReferralAReferrerMadeASuccessfulReferralTheReferredCustomerPlacedTheFirstOrdermaturityGAexposurePublic: '{\"order\":7,\"value\":\"REFERRAL_REFERRER\",\"description\":\"Issued from a referral - a referrer made a successful referral. The referred customer placed the first order\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
 ...
 * Detailed information about a Gift Card that belongs to a Store Credit Wallet.
 */
export interface StoreCreditOptions1 {
    'storeCreditOptions'?: StoreCreditOptions1;
}
/**
 * 
 */
 ...
 */
export interface StoreCreditRefundOptions1 {
    'storeCreditRefundOptions'?: StoreCreditRefundOptions1;
}
/**
 * 
 */
...
export const Target = {
    Order1valueSchedulEdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"SCHEDULE\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueImmediatEdescriptionMaturityGAexposurePublic: '{\"order\":2,\"value\":\"IMMEDIATE\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
...
export const TimePeriod = {
    Order0valueUnknowNdescriptionMaturityGAexposurePublic: '{\"order\":0,\"value\":\"UNKNOWN\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order1valueDaySdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"DAYS\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueWeekSdescriptionMaturityGAexposurePublic: '{\"order\":2,\"value\":\"WEEKS\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order3valueMonthSdescriptionMaturityGAexposurePublic: '{\"order\":3,\"value\":\"MONTHS\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order4valueYearSdescriptionMaturityGAexposurePublic: '{\"order\":4,\"value\":\"YEARS\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
...
export const TimeUnit = {
    Order1valueMinuteSdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"MINUTES\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueHourSdescriptionMaturityGAexposurePublic: '{\"order\":2,\"value\":\"HOURS\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order3valueDaySdescriptionMaturityGAexposurePublic: '{\"order\":3,\"value\":\"DAYS\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order4valueWeekSdescriptionMaturityGAexposurePublic: '{\"order\":4,\"value\":\"WEEKS\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order5valueMonthSdescriptionMaturityGAexposurePublic: '{\"order\":5,\"value\":\"MONTHS\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
 ...
 */
export type Transaction1 = BulkOptions1 | CampaignOptions1 | InitialOptions1 | ManualOptions1 | MigrationOptions1 | PaymentMethodRefundOptions1 | RedeemOptions1 | RewardOptions1 | StoreCreditRefundOptions1 | VoidOptions1 | WalletActionEndOptions1 | WalletActionStartOptions1;

/**
 * @type Transaction2
 * The created Transaction.
 */
export type Transaction2 = BulkOptions1 | CampaignOptions1 | InitialOptions1 | ManualOptions1 | MigrationOptions1 | PaymentMethodRefundOptions1 | RedeemOptions1 | RewardOptions1 | StoreCreditRefundOptions1 | VoidOptions1 | WalletActionEndOptions1 | WalletActionStartOptions1;

/**
 * @type Transaction3
 * The Transaction to be created.
 */
export type Transaction3 = BulkOptions1 | CampaignOptions1 | InitialOptions1 | ManualOptions1 | MigrationOptions1 | PaymentMethodRefundOptions1 | RedeemOptions1 | RewardOptions1 | StoreCreditRefundOptions1 | VoidOptions1 | WalletActionEndOptions1 | WalletActionStartOptions1;
...
export const TransactionType = {
    Order1valueRedeeMdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"REDEEM\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueVoiDdescriptionVoidOfAPreviousTransactionMaturityGAexposurePublic: '{\"order\":2,\"value\":\"VOID\",\"description\":\"Void of a previous transaction.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order3valueRewarDdescriptionMaturityGAexposurePublic: '{\"order\":3,\"value\":\"REWARD\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order4valueWalletActionEnDdescriptionEndOfAWalletActionStoreCreditMaturityGAexposurePublic: '{\"order\":4,\"value\":\"WALLET_ACTION_END\",\"description\":\"End of a wallet action (store credit).\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order5valueManuaLdescriptionIssuedFromTheDashboardMaturityGAexposurePublic: '{\"order\":5,\"value\":\"MANUAL\",\"description\":\"Issued from the dashboard.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order6valueCampaigNdescriptionMaturityGAexposurePublic: '{\"order\":6,\"value\":\"CAMPAIGN\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order7valueStoreCreditRefunDdescriptionMaturityGAexposurePublic: '{\"order\":7,\"value\":\"STORE_CREDIT_REFUND\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order8valueMigratioNdescriptionMigrationFromRiseV1OrAnotherPlatformMaturityGAexposurePublic: '{\"order\":8,\"value\":\"MIGRATION\",\"description\":\"Migration from Rise V1 or another platform.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order9valueInitiaLdescriptionInitialTransactionForAGiftCardMaturityGAexposurePublic: '{\"order\":9,\"value\":\"INITIAL\",\"description\":\"Initial transaction for a gift card.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order10valuePaymentMethodRefunDdescriptionRefundingAPaymentMethodMaturityGAexposurePublic: '{\"order\":10,\"value\":\"PAYMENT_METHOD_REFUND\",\"description\":\"Refunding a payment method.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order11valueWalletActionStarTdescriptionStartOfAWalletActionStoreCreditMaturityGAexposurePublic: '{\"order\":11,\"value\":\"WALLET_ACTION_START\",\"description\":\"Start of a wallet action (store credit).\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order12valueBulKdescriptionMaturityGAexposurePublic: '{\"order\":12,\"value\":\"BULK\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
...
export const Type = {
    Order1valueAppDefineDdescriptionAppDefinedActionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"APP_DEFINED\",\"description\":\"App defined Action.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueConditioNdescriptionConditionActionMaturityGAexposurePublic: '{\"order\":2,\"value\":\"CONDITION\",\"description\":\"Condition Action.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order3valueDelaYdescriptionDelayActionMaturityGAexposurePublic: '{\"order\":3,\"value\":\"DELAY\",\"description\":\"Delay Action.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order4valueRateLimiTdescriptionRateLimitActionMaturityGAexposurePublic: '{\"order\":4,\"value\":\"RATE_LIMIT\",\"description\":\"RateLimit Action.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order7valueSpliTdescriptionSplitActionMaturityGAexposurePublic: '{\"order\":7,\"value\":\"SPLIT\",\"description\":\"Split Action.\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
 ...
 * 
 */
export interface UpdateCustomerReferenceRequest {
    /**
     * 
     */
    'customerReference'?: object;
 ...
 * 
 */
export interface UpdateCustomerReferenceResponse {
    /**
     * Customer reference
     */
    'customerReference'?: object;
 ...
 * 
 */
export interface UpdateGiftCardResponse1 {
    'giftCard'?: GiftCard3;
}
/**
 * 
 ...
 * 
 */
export interface UpdateLastActivityForRemindersResponse {
    /**
     * Updated Gift Card
     */
    'giftCard'?: object;
 ...
 * 
 */
export interface UpdateOrderResponse1 {
 ...
 * 
 */
export interface UpdateWalletActionRequest {
    /**
 ...
 * 
 */
export interface UpdateWalletActionResponse1 {
 ...
 * Value aggregation results.
 */
export interface ValueResults1 {
    'values'?: ValueResults1;
}
/**
 * 
 */
export interface VoidFailedDetails {
    /**
     * Gift Card Id
     */
    'transactionId'?: string;
 ...
 * Information about a transaction that comes to void a previous transaction.
 */
export interface VoidOptions1 {
    'voidOptions'?: VoidOptions1;
}
/**
 * 
 */
...
export interface WalletAction1 {
     ...
     */
    'liability'?: boolean;
    'storeCreditContext'?: StoreCreditContext2;
...
export const WalletAction1TypeEnum = {
    Order0valueUnknowNdescriptionMaturityGAexposurePublic: '{\"order\":0,\"value\":\"UNKNOWN\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order1valueRewarDdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"REWARD\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueRefunDdescriptionMaturityGAexposurePublic: '{\"order\":2,\"value\":\"REFUND\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
...
export const WalletAction1StatusEnum = {
    Order0valuePendinGdescriptionMaturityGAexposurePublic: '{\"order\":0,\"value\":\"PENDING\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order1valueActivEdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"ACTIVE\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueDisableDdescriptionMaturityGAexposurePublic: '{\"order\":2,\"value\":\"DISABLED\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order3valueExpireDdescriptionMaturityGAexposurePublic: '{\"order\":3,\"value\":\"EXPIRED\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order4valueFaileDdescriptionMaturityGAexposurePublic: '{\"order\":4,\"value\":\"FAILED\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
 ...
 * Information about a transaction whose source is the end of a wallet action (store credit).
 */
export interface WalletActionEndOptions1 {
    'walletActionEndOptions'?: WalletActionEndOptions1;
}
/**
 * 
 */
...
export const WalletActionEndReason = {
    Order1valueCanceLdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"CANCEL\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueExpiratioNdescriptionMaturityGAexposurePublic: '{\"order\":2,\"value\":\"EXPIRATION\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
 ...
 * 
 */
export interface WalletActionExpired {
    /**
     * 
     */
    'walletAction'?: object;
 ...
 * Information about a transaction whose source is a wallet action (store credit) to a customer.
 */
export interface WalletActionStartOptions1 {
    'walletActionStartOptions'?: WalletActionStartOptions1;
}
/**
 * 
 */
export interface WalletActionStarted {
    /**
     * 
     */
    'walletAction'?: object;
 ...
 * 
 */
export interface WalletActionWalletActionServiceV1RiseWalletActionsQueryBalancesPostQueryWalletActionsBalancesRequestBody {
    'query': QueryV22;
}
/**
 * 
 ...
 * 
 */
export interface WalletActionWalletActionServiceV1RiseWalletActionsQueryUnredeemedPostQueryUnredeemedWalletActionsRequestBody {
    'query': QueryV22;
}
/**
 * 
 ...
 * 
 */
export interface WalletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody {
    'query': QueryV22;
}
/**
 * 
...
export const WebhookIdentityType = {
    Order0valueUnknowNdescriptionMaturityGAexposurePublic: '{\"order\":0,\"value\":\"UNKNOWN\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order1valueAnonymousVisitoRdescriptionMaturityGAexposurePublic: '{\"order\":1,\"value\":\"ANONYMOUS_VISITOR\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order2valueMembeRdescriptionMaturityGAexposurePublic: '{\"order\":2,\"value\":\"MEMBER\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order3valueWixUseRdescriptionMaturityGAexposurePublic: '{\"order\":3,\"value\":\"WIX_USER\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}',
    Order4valueApPdescriptionMaturityGAexposurePublic: '{\"order\":4,\"value\":\"APP\",\"description\":\"\",\"maturity\":\"GA\",\"exposure\":\"PUBLIC\"}'
} as const;
 ...
 * Detailed information about a Gift Card issued from a workflow.
 */
export interface WorkflowOptions1 {
    'workflowOptions'?: WorkflowOptions1;
}
/**
 * 
 */
...
export const GiftCardApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {GiftCardGiftCardServiceV1RiseGiftCardsTransactionGiftCardIdDecreasePostDecreaseBalanceRequestBody} giftCardGiftCardServiceV1RiseGiftCardsTransactionGiftCardIdDecreasePostDecreaseBalanceRequestBody 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        decreaseBalance: async (transactionGiftCardId: string, giftCardGiftCardServiceV1RiseGiftCardsTransactionGiftCardIdDecreasePostDecreaseBalanceRequestBody: GiftCardGiftCardServiceV1RiseGiftCardsTransactionGiftCardIdDecreasePostDecreaseBalanceRequestBody, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            // verify required parameter 'giftCardGiftCardServiceV1RiseGiftCardsTransactionGiftCardIdDecreasePostDecreaseBalanceRequestBody' is not null or undefined
            assertParamExists('decreaseBalance', 'giftCardGiftCardServiceV1RiseGiftCardsTransactionGiftCardIdDecreasePostDecreaseBalanceRequestBody', giftCardGiftCardServiceV1RiseGiftCardsTransactionGiftCardIdDecreasePostDecreaseBalanceRequestBody)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(giftCardGiftCardServiceV1RiseGiftCardsTransactionGiftCardIdDecreasePostDecreaseBalanceRequestBody, localVarRequestOptions, configuration)
...
export const GiftCardApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createGiftCard(giftCardGiftCardServiceV1RiseGiftCardsPostCreateGiftCardRequestBody: GiftCardGiftCardServiceV1RiseGiftCardsPostCreateGiftCardRequestBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateGiftCardResponse1>> {
         ...
         * @throws {RequiredError}
         */
        async decreaseBalance(transactionGiftCardId: string, giftCardGiftCardServiceV1RiseGiftCardsTransactionGiftCardIdDecreasePostDecreaseBalanceRequestBody: GiftCardGiftCardServiceV1RiseGiftCardsTransactionGiftCardIdDecreasePostDecreaseBalanceRequestBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DecreaseBalanceResponse1>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.decreaseBalance(transactionGiftCardId, giftCardGiftCardServiceV1RiseGiftCardsTransactionGiftCardIdDecreasePostDecreaseBalanceRequestBody, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async disableGiftCard(giftCardId: string, body: object, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DisableGiftCardResponse1>> {
         ...
         * @throws {RequiredError}
         */
        async getGiftCard(giftCardId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetGiftCardResponse1>> {
         ...
         * @throws {RequiredError}
         */
        async updateGiftCard(giftCardId: string, giftCardGiftCardServiceV1RiseGiftCardsGiftCardIdPatchUpdateGiftCardRequestBody: GiftCardGiftCardServiceV1RiseGiftCardsGiftCardIdPatchUpdateGiftCardRequestBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UpdateGiftCardResponse1>> {
...
export const GiftCardApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createGiftCard(giftCardGiftCardServiceV1RiseGiftCardsPostCreateGiftCardRequestBody: GiftCardGiftCardServiceV1RiseGiftCardsPostCreateGiftCardRequestBody, options?: RawAxiosRequestConfig): AxiosPromise<CreateGiftCardResponse1> {
         ...
         * @throws {RequiredError}
         */
        decreaseBalance(transactionGiftCardId: string, giftCardGiftCardServiceV1RiseGiftCardsTransactionGiftCardIdDecreasePostDecreaseBalanceRequestBody: GiftCardGiftCardServiceV1RiseGiftCardsTransactionGiftCardIdDecreasePostDecreaseBalanceRequestBody, options?: RawAxiosRequestConfig): AxiosPromise<DecreaseBalanceResponse1> {
            return localVarFp.decreaseBalance(transactionGiftCardId, giftCardGiftCardServiceV1RiseGiftCardsTransactionGiftCardIdDecreasePostDecreaseBalanceRequestBody, options).then((request) => request(axios, basePath));
        },
        /**
         * Disable a GiftCard. It cannot be re-enabled.
         * @param {string} giftCardId The ID of the GiftCard to disable.
         ...
         * @throws {RequiredError}
         */
        disableGiftCard(giftCardId: string, body: object, options?: RawAxiosRequestConfig): AxiosPromise<DisableGiftCardResponse1> {
         ...
         * @throws {RequiredError}
         */
        getGiftCard(giftCardId: string, options?: RawAxiosRequestConfig): AxiosPromise<GetGiftCardResponse1> {
         ...
         * @throws {RequiredError}
         */
        updateGiftCard(giftCardId: string, giftCardGiftCardServiceV1RiseGiftCardsGiftCardIdPatchUpdateGiftCardRequestBody: GiftCardGiftCardServiceV1RiseGiftCardsGiftCardIdPatchUpdateGiftCardRequestBody, options?: RawAxiosRequestConfig): AxiosPromise<UpdateGiftCardResponse1> {
...
export class GiftCardApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public decreaseBalance(transactionGiftCardId: string, giftCardGiftCardServiceV1RiseGiftCardsTransactionGiftCardIdDecreasePostDecreaseBalanceRequestBody: GiftCardGiftCardServiceV1RiseGiftCardsTransactionGiftCardIdDecreasePostDecreaseBalanceRequestBody, options?: RawAxiosRequestConfig) {
        return GiftCardApiFp(this.configuration).decreaseBalance(transactionGiftCardId, giftCardGiftCardServiceV1RiseGiftCardsTransactionGiftCardIdDecreasePostDecreaseBalanceRequestBody, options).then((request) => request(this.axios, this.basePath));
    }
...
export const GiftCardOrderApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createOrder(giftCardOrderGiftCardOrderServiceV1RiseOrdersPostCreateOrderRequestBody: GiftCardOrderGiftCardOrderServiceV1RiseOrdersPostCreateOrderRequestBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateOrderResponse1>> {
         ...
         * @throws {RequiredError}
         */
        async updateOrder(orderId: string, giftCardOrderGiftCardOrderServiceV1RiseOrdersOrderIdPatchUpdateOrderRequestBody: GiftCardOrderGiftCardOrderServiceV1RiseOrdersOrderIdPatchUpdateOrderRequestBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UpdateOrderResponse1>> {
...
export const GiftCardOrderApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createOrder(giftCardOrderGiftCardOrderServiceV1RiseOrdersPostCreateOrderRequestBody: GiftCardOrderGiftCardOrderServiceV1RiseOrdersPostCreateOrderRequestBody, options?: RawAxiosRequestConfig): AxiosPromise<CreateOrderResponse1> {
         ...
         * @throws {RequiredError}
         */
        updateOrder(orderId: string, giftCardOrderGiftCardOrderServiceV1RiseOrdersOrderIdPatchUpdateOrderRequestBody: GiftCardOrderGiftCardOrderServiceV1RiseOrdersOrderIdPatchUpdateOrderRequestBody, options?: RawAxiosRequestConfig): AxiosPromise<UpdateOrderResponse1> {
...
export const RecipientApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getRecipient(recipientId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetRecipientResponse1>> {
...
export const RecipientApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getRecipient(recipientId: string, options?: RawAxiosRequestConfig): AxiosPromise<GetRecipientResponse1> {
...
export const WalletApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {WalletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody} walletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        queryWallets: async (walletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody: WalletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'walletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody' is not null or undefined
            assertParamExists('queryWallets', 'walletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody', walletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(walletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody, localVarRequestOptions, configuration)
...
export const WalletApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async countWallets(walletWalletServiceV1RiseWalletsCountPostCountWalletsRequestBody: WalletWalletServiceV1RiseWalletsCountPostCountWalletsRequestBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CountWalletsResponse1>> {
         ...
         * @throws {RequiredError}
         */
        async getCustomerReference(query: CustomerReferenceQuery, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetCustomerReferenceResponse1>> {
         ...
         * @throws {RequiredError}
         */
        async getOrCreateWallet(walletWalletServiceV1RiseWalletsIssuePostGetOrCreateWalletRequestBody: WalletWalletServiceV1RiseWalletsIssuePostGetOrCreateWalletRequestBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetOrCreateWalletResponse1>> {
         ...
         * @throws {RequiredError}
         */
        async getWallet(query: object, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetWalletResponse1>> {
         ...
         * @throws {RequiredError}
         */
        async queryWallets(walletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody: WalletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QueryWalletsResponse1>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.queryWallets(walletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const WalletApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        countWallets(walletWalletServiceV1RiseWalletsCountPostCountWalletsRequestBody: WalletWalletServiceV1RiseWalletsCountPostCountWalletsRequestBody, options?: RawAxiosRequestConfig): AxiosPromise<CountWalletsResponse1> {
         ...
         * @throws {RequiredError}
         */
        getCustomerReference(query: CustomerReferenceQuery, options?: RawAxiosRequestConfig): AxiosPromise<GetCustomerReferenceResponse1> {
         ...
         * @throws {RequiredError}
         */
        getOrCreateWallet(walletWalletServiceV1RiseWalletsIssuePostGetOrCreateWalletRequestBody: WalletWalletServiceV1RiseWalletsIssuePostGetOrCreateWalletRequestBody, options?: RawAxiosRequestConfig): AxiosPromise<GetOrCreateWalletResponse1> {
         ...
         * @throws {RequiredError}
         */
        getWallet(query: object, options?: RawAxiosRequestConfig): AxiosPromise<GetWalletResponse1> {
         ...
         * @throws {RequiredError}
         */
        queryWallets(walletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody: WalletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody, options?: RawAxiosRequestConfig): AxiosPromise<QueryWalletsResponse1> {
            return localVarFp.queryWallets(walletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody, options).then((request) => request(axios, basePath));
        },
        /**
         * Query wallets by contact using [API Query Language](https://platform.rise.ai/docs/#tag/About-API-Query-Language). The result is a list of wallets with gift card and contact information.
         * @param {WalletWalletServiceV1RiseWalletsQueryByContactPostQueryWalletsByContactRequestBody} walletWalletServiceV1RiseWalletsQueryByContactPostQueryWalletsByContactRequestBody 
...
export class WalletApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public queryWallets(walletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody: WalletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody, options?: RawAxiosRequestConfig) {
        return WalletApiFp(this.configuration).queryWallets(walletWalletServiceV1RiseWalletsQueryPostQueryWalletsRequestBody, options).then((request) => request(this.axios, this.basePath));
    }
...
export const WalletActionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {WalletActionWalletActionServiceV1RiseWalletActionsQueryUnredeemedPostQueryUnredeemedWalletActionsRequestBody} walletActionWalletActionServiceV1RiseWalletActionsQueryUnredeemedPostQueryUnredeemedWalletActionsRequestBody 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        queryUnredeemedWalletActions: async (walletActionWalletActionServiceV1RiseWalletActionsQueryUnredeemedPostQueryUnredeemedWalletActionsRequestBody: WalletActionWalletActionServiceV1RiseWalletActionsQueryUnredeemedPostQueryUnredeemedWalletActionsRequestBody, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'walletActionWalletActionServiceV1RiseWalletActionsQueryUnredeemedPostQueryUnredeemedWalletActionsRequestBody' is not null or undefined
            assertParamExists('queryUnredeemedWalletActions', 'walletActionWalletActionServiceV1RiseWalletActionsQueryUnredeemedPostQueryUnredeemedWalletActionsRequestBody', walletActionWalletActionServiceV1RiseWalletActionsQueryUnredeemedPostQueryUnredeemedWalletActionsRequestBody)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(walletActionWalletActionServiceV1RiseWalletActionsQueryUnredeemedPostQueryUnredeemedWalletActionsRequestBody, localVarRequestOptions, configuration)
         ...
         * @param {WalletActionWalletActionServiceV1RiseWalletActionsQueryBalancesPostQueryWalletActionsBalancesRequestBody} walletActionWalletActionServiceV1RiseWalletActionsQueryBalancesPostQueryWalletActionsBalancesRequestBody 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        queryWalletActionsBalances: async (walletActionWalletActionServiceV1RiseWalletActionsQueryBalancesPostQueryWalletActionsBalancesRequestBody: WalletActionWalletActionServiceV1RiseWalletActionsQueryBalancesPostQueryWalletActionsBalancesRequestBody, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'walletActionWalletActionServiceV1RiseWalletActionsQueryBalancesPostQueryWalletActionsBalancesRequestBody' is not null or undefined
            assertParamExists('queryWalletActionsBalances', 'walletActionWalletActionServiceV1RiseWalletActionsQueryBalancesPostQueryWalletActionsBalancesRequestBody', walletActionWalletActionServiceV1RiseWalletActionsQueryBalancesPostQueryWalletActionsBalancesRequestBody)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(walletActionWalletActionServiceV1RiseWalletActionsQueryBalancesPostQueryWalletActionsBalancesRequestBody, localVarRequestOptions, configuration)
...
export const WalletActionApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async disableWalletAction(walletActionId: string, walletActionWalletActionServiceV1RiseWalletActionsWalletActionIdDisablePostDisableWalletActionRequestBody: WalletActionWalletActionServiceV1RiseWalletActionsWalletActionIdDisablePostDisableWalletActionRequestBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DisableWalletActionResponse1>> {
         ...
         * @throws {RequiredError}
         */
        async queryUnredeemedWalletActions(walletActionWalletActionServiceV1RiseWalletActionsQueryUnredeemedPostQueryUnredeemedWalletActionsRequestBody: WalletActionWalletActionServiceV1RiseWalletActionsQueryUnredeemedPostQueryUnredeemedWalletActionsRequestBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QueryUnredeemedWalletActionsResponse1>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.queryUnredeemedWalletActions(walletActionWalletActionServiceV1RiseWalletActionsQueryUnredeemedPostQueryUnredeemedWalletActionsRequestBody, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
        ...
        async queryWalletActionsBalances(walletActionWalletActionServiceV1RiseWalletActionsQueryBalancesPostQueryWalletActionsBalancesRequestBody: WalletActionWalletActionServiceV1RiseWalletActionsQueryBalancesPostQueryWalletActionsBalancesRequestBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QueryWalletActionBalancesResponse1>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.queryWalletActionsBalances(walletActionWalletActionServiceV1RiseWalletActionsQueryBalancesPostQueryWalletActionsBalancesRequestBody, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const WalletActionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createWalletAction(walletActionWalletActionServiceV1RiseWalletActionsPostCreateWalletActionRequestBody: WalletActionWalletActionServiceV1RiseWalletActionsPostCreateWalletActionRequestBody, options?: RawAxiosRequestConfig): AxiosPromise<CreateWalletActionResponse1> {
         ...
         * @throws {RequiredError}
         */
        disableWalletAction(walletActionId: string, walletActionWalletActionServiceV1RiseWalletActionsWalletActionIdDisablePostDisableWalletActionRequestBody: WalletActionWalletActionServiceV1RiseWalletActionsWalletActionIdDisablePostDisableWalletActionRequestBody, options?: RawAxiosRequestConfig): AxiosPromise<DisableWalletActionResponse1> {
         ...
         * @throws {RequiredError}
         */
        queryUnredeemedWalletActions(walletActionWalletActionServiceV1RiseWalletActionsQueryUnredeemedPostQueryUnredeemedWalletActionsRequestBody: WalletActionWalletActionServiceV1RiseWalletActionsQueryUnredeemedPostQueryUnredeemedWalletActionsRequestBody, options?: RawAxiosRequestConfig): AxiosPromise<QueryUnredeemedWalletActionsResponse1> {
            return localVarFp.queryUnredeemedWalletActions(walletActionWalletActionServiceV1RiseWalletActionsQueryUnredeemedPostQueryUnredeemedWalletActionsRequestBody, options).then((request) => request(axios, basePath));
        },
        /**
         * Query WalletActions using [API Query Language](https://platform.rise.ai/docs/#tag/About-API-Query-Language).
         * @param {WalletActionWalletActionServiceV1RiseWalletActionsQueryPostQueryWalletActionsRequestBody} walletActionWalletActionServiceV1RiseWalletActionsQueryPostQueryWalletActionsRequestBody 
         ...
         * @throws {RequiredError}
         */
        queryWalletActionsBalances(walletActionWalletActionServiceV1RiseWalletActionsQueryBalancesPostQueryWalletActionsBalancesRequestBody: WalletActionWalletActionServiceV1RiseWalletActionsQueryBalancesPostQueryWalletActionsBalancesRequestBody, options?: RawAxiosRequestConfig): AxiosPromise<QueryWalletActionBalancesResponse1> {
            return localVarFp.queryWalletActionsBalances(walletActionWalletActionServiceV1RiseWalletActionsQueryBalancesPostQueryWalletActionsBalancesRequestBody, options).then((request) => request(axios, basePath));
        },
        /**
         * Update a WalletAction, supports partial update. Pass the latest `revision` for a successful update.
         * @param {string} walletActionId WalletAction ID.
         ...
         * @throws {RequiredError}
         */
        updateWalletAction(walletActionId: string, walletActionWalletActionServiceV1RiseWalletActionsWalletActionIdPatchUpdateWalletActionRequestBody: WalletActionWalletActionServiceV1RiseWalletActionsWalletActionIdPatchUpdateWalletActionRequestBody, options?: RawAxiosRequestConfig): AxiosPromise<UpdateWalletActionResponse1> {
...
export class WalletActionApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public queryUnredeemedWalletActions(walletActionWalletActionServiceV1RiseWalletActionsQueryUnredeemedPostQueryUnredeemedWalletActionsRequestBody: WalletActionWalletActionServiceV1RiseWalletActionsQueryUnredeemedPostQueryUnredeemedWalletActionsRequestBody, options?: RawAxiosRequestConfig) {
        return WalletActionApiFp(this.configuration).queryUnredeemedWalletActions(walletActionWalletActionServiceV1RiseWalletActionsQueryUnredeemedPostQueryUnredeemedWalletActionsRequestBody, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public queryWalletActionsBalances(walletActionWalletActionServiceV1RiseWalletActionsQueryBalancesPostQueryWalletActionsBalancesRequestBody: WalletActionWalletActionServiceV1RiseWalletActionsQueryBalancesPostQueryWalletActionsBalancesRequestBody, options?: RawAxiosRequestConfig) {
        return WalletActionApiFp(this.configuration).queryWalletActionsBalances(walletActionWalletActionServiceV1RiseWalletActionsQueryBalancesPostQueryWalletActionsBalancesRequestBody, options).then((request) => request(this.axios, this.basePath));
    }
